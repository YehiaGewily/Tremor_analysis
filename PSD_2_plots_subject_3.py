...
file_location_for_day1_before = r'E:\Tremor\Subject #3\data\day_1_before.MOV_tremor_amplitudes.csv'


file_location_for_day15_after = r'E:\Tremor\Subject #3\data\day_15_after_tremor_amplitudes.csv'
...
plt.title('Day 1 (Before Stimulation) Patient #3', fontsize=14)
plt.xlim(0, 15)
...
plt.xlabel('Frequency (Hz)', fontsize=12)
plt.ylabel('Power Spectral Density', fontsize=12)
plt.title('Day 15 (After Stimulation)', fontsize=14)
plt.xlim(0, 15)
plt.grid(True, linestyle='--', alpha=0.7)
...
plt.xlabel('Frequency (Hz)', fontsize=12)
plt.ylabel('Power Spectral Density', fontsize=12)
plt.title('Tremor PSD: Before vs After Stimulation (Patient #3)', fontsize=14)
plt.xlim(0, 15)
plt.grid(True, linestyle='--', alpha=0.7)
...
plt.title('Smoothed Tremor PSD: Before vs After Stimulation (patient #3)', fontsize=14)
plt.xlim(0, 15)
plt.grid(True, linestyle='--', alpha=0.7)
