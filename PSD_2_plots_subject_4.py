...
file_location_for_day1_before = r'E:\Tremor\Subject #4\data\day_1_before.MOV_tremor_amplitudes.csv'


file_location_for_day15_after = r'E:\Tremor\Subject #4\data\day_5_after.MOV_tremor_amplitudes.csv'
...
plt.subplot(2, 2, 1)
plt.semilogy(frequencies_day_1, power_day_1, linewidth=2, color='blue')
plt.xlabel('Frequency (Hz)', fontsize=12)
plt.ylabel('Power Spectral Density', fontsize=12)
plt.title('Day 1 (Before Stimulation) Patient #4', fontsize=14)
plt.xlim(0, 15)
...
plt.subplot(2, 2, 2)
plt.semilogy(frequencies_day_15, power_day_15, linewidth=2, color='green')
plt.xlabel('Frequency (Hz)', fontsize=12)
plt.ylabel('Power Spectral Density', fontsize=12)
plt.title('Day 5 (After Stimulation) Patient #4', fontsize=14)
plt.xlim(0, 15)
plt.grid(True, linestyle='--', alpha=0.7)
...
plt.xlabel('Frequency (Hz)', fontsize=12)
plt.ylabel('Power Spectral Density', fontsize=12)
plt.title('Tremor PSD: Before vs After Stimulation (Patient #4)', fontsize=14)
plt.xlim(0, 15)
plt.grid(True, linestyle='--', alpha=0.7)
...
plt.title('Smoothed Tremor PSD: Before vs After Stimulation (Patient #4)', fontsize=14)
plt.xlim(0, 15)
plt.grid(True, linestyle='--', alpha=0.7)
